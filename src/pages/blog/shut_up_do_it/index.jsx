  ...
  render : function(){
    return <div>
      <Helmet
        ...
        { name: 'og:image', content: 'http://cdn.ytadvisors.com/images/blog/shutup.jpg' },
        { name: 'og:description', content: "Custom web, mobile, digital, and desktop software development and consulting services." },
        { name: 'og:image:width', content: "650" },
        { name: 'og:image:height', content: "497" },
        { name: 'og:site_name', content: "ytadvisors" },
