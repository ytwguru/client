  ...
  render() {
    return <div>
      <Helmet
        ...
        script={[
        { "type": "text/javascript", "innerHTML": `(function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){
