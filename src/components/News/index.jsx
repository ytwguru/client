      ...
      <div className="container imgHover">
        <div className="row">
          ...
          <article className="col-md-4">
            <section className="imgWrapper"> <img src="https://cdn.ytadvisors.com/images/news/news1.jpg" alt="alteae template image news" /> </section>
          ...
          <article className="col-md-4">
            <section className="imgWrapper">
              <img src="https://cdn.ytadvisors.com/images/news/news2.jpg" alt="snowflake template image news" />
            </section>
            <div className="media-hover">
              <div className="mask"></div>
            </div>
          ...
          <article className="col-md-4">
            <section className="imgWrapper"> <img src="https://cdn.ytadvisors.com/images/news/news3.jpg" alt="snowflake template image news" /> </section>
            <div className="media-hover">
              <div className="mask"></div>
            </div>
            <div className="media-list newsList">
