  ...
  render(){
    return <div id="home">
      <div className="carousel" >
        <div className="carousel-cell">
          <section className = "imgWrapper">
            <img data-src= "https://cdn.ytadvisors.com/images/slider/super/placeholder.jpg"
              data-flickity-lazyload="https://cdn.ytadvisors.com/images/slider/super/supersized-1.jpg" className="img-responsive" id = "main-image" alt="Women in business"/>
      ...
      <div className="carousel">
        <div className="carousel-cell">
          <section className = "imgWrapper">
            <img data-src= "https://cdn.ytadvisors.com/images/slider/super/placeholder.jpg" alt="Black family"
                 data-flickity-lazyload="https://cdn.ytadvisors.com/images/slider/super/supersized-2.jpg" className="img-responsive" />
            <div className = "content">
      ...
      <div className="carousel">
        <div className="carousel-cell">
          <section className = "imgWrapper">
            <img data-src= "https://cdn.ytadvisors.com/images/slider/super/placeholder.jpg"
                 data-flickity-lazyload="https://cdn.ytadvisors.com/images/slider/super/supersized-3.jpg" className="img-responsive" alt="Cyber security"/>
            <div className = "content">
      ...
      <div className="carousel">
        <div className="carousel-cell">
          <section className = "imgWrapper">
            <img data-src= "https://cdn.ytadvisors.com/images/slider/super/placeholder.jpg" alt="Project managers"
                 data-flickity-lazyload="https://cdn.ytadvisors.com/images/slider/super/supersized-4.jpg" className="img-responsive" />
            <div className = "content">
