            ...
            <article className="boxWrapper color1">
              ...
              <div className="boxContent color3"> 
                ...
                <ul className="socialNetwork">
                  ...
                  <li><a href="http://plus.google.com/109638795509632465576" className="tips" title="" data-original-title="follow me on Google+"><i className="icon-gplus"></i></a></li>
                  <li><a href="http://www.linkedin.com/in/yomi-toba-569884a" className="tips" title="" data-original-title="follow me on Linkedin"><i className="icon-linkedin"></i></a></li>
            ...
            <article className="boxWrapper color1">
              ...
              <div className="boxContent color3">
                ...
                <ul className="socialNetwork">
                  ...
                  <li><a href="http://www.linkedin.com/in/tanyajhamilton" className="tips" title="" data-original-title="follow me on Linkedin"><i className="icon-linkedin"></i></a></li>
                  <li><a href="#" className="tips" title="" data-original-title="follow me on Pinterest"><i className="icon-pinterest-circled"></i></a></li>
                </ul>
              </div>
            </article>
