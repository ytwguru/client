...
class Header extends React.Component{
  ...
  componentDidMount(){
    ...
    if(!isMobile){
      ...
      $navBar.affix({
        offset: { top: this.props.data.page === "home" ? height : 0 }
      });

      $('#nav-wrapper').height($navBar.height());

      $(document).on("resizeWindow", function () {
  ...
  render(){
    ...
    return <div id="nav-wrapper">
        <nav role="navigation" className="navbar navbar-default affix-top" data-spy="affix">
          <div className="container">
            <div className="navbar-header">
              ...
              <a href={`${prefix}#`} className="navbar-brand">
                <img className="img-responsive mainImage" src="https://cdn.ytadvisors.com/images/white-logo.png" alt="YT Advisors" />
              </a>
            </div>
            <div id="navbarCollapse" className="collapse navbar-collapse">
              <ul className="nav navbar-nav">
                <li className={this.getLinkClass("home")}><a href="/">Home</a> </li>
                ...
                <li className={this.getLinkClass("team")}><a href="/team/">Team</a> </li>
